...
1. [REQ-IND-001 — Three-column layout](#req-ind-001)
2. [REQ-IND-002 — Class tree with transitive counters](#req-ind-002)
3. [REQ-IND-003 — Filtered and sorted individuals list](#req-ind-003)
4. [REQ-IND-004 — Class selection in the tree](#req-ind-004)
5. [REQ-IND-005 — Simple individual selection](#req-ind-005)
6. [REQ-IND-006 — Multiple selection via Shift+Click](#req-ind-006)
7. [REQ-IND-007 — Creating a new individual](#req-ind-007)
8. [REQ-IND-008 — Cancelling the creation form](#req-ind-008)
9. [REQ-IND-009 — Deleting one or more individuals](#req-ind-009)
10. [REQ-IND-010 — Moving by drag-and-drop to a class](#req-ind-010)
11. [REQ-IND-011 — Individual detail form](#req-ind-011)
12. [REQ-IND-012 — IRI identifier displayed in the form header](#req-ind-012)
13. [REQ-IND-013 — Annotations: labels and comments](#req-ind-013)
14. [REQ-IND-014 — Custom property annotations](#req-ind-014)
15. [REQ-IND-015 — Type management (rdf:type)](#req-ind-015)
16. [REQ-IND-016 — Dynamic property panels (Object Properties)](#req-ind-016)
17. [REQ-IND-017 — Dynamic property panels (Datatype Properties)](#req-ind-017)
18. [REQ-IND-018 — Functional cardinality management for properties](#req-ind-018)
19. [REQ-IND-019 — Opening the individual picker for an Object Property](#req-ind-019)
20. [REQ-IND-020 — Creating an individual on the fly from the picker](#req-ind-020)
21. [REQ-IND-021 — Auto-save (autoSave)](#req-ind-021)
22. [REQ-IND-022 — Explicit save: creation and update](#req-ind-022)
23. [REQ-IND-023 — Deleting a single individual from the form](#req-ind-023)
24. [REQ-IND-024 — Preservation of sameAs and differentFrom during save](#req-ind-024)
25. [REQ-IND-025 — Collecting object assertions from panels](#req-ind-025)
26. [REQ-IND-026 — Collecting data assertions from panels](#req-ind-026)
27. [REQ-IND-027 — Simple display rule (single property)](#req-ind-027)
28. [REQ-IND-028 — Composite display rule (multi-property with separator)](#req-ind-028)
29. [REQ-IND-029 — Display label resolution by class inheritance](#req-ind-029)
30. [REQ-IND-030 — Multilingual rdfs:label resolution](#req-ind-030)
31. [REQ-IND-031 — Persistence of display rules in the ontology](#req-ind-031)
32. [REQ-IND-032 — Automatic identifier generation for a new individual](#req-ind-032)
33. [REQ-IND-033 — Navigation to a target individual from an Object Property](#req-ind-033)
34. [REQ-IND-034 — Clickable link for URL-typed data values](#req-ind-034)
35. [REQ-IND-035 — "Where Used" panel in the form](#req-ind-035)
36. [REQ-IND-036 — Column resizing by drag-and-drop](#req-ind-036)
37. [REQ-IND-037 — Hierarchical class depth for ordering](#req-ind-037)
38. [REQ-IND-038 — Separate collection of inherited and direct properties](#req-ind-038)
39. [REQ-IND-039 — Filtering candidate individuals by an OP's range](#req-ind-039)
