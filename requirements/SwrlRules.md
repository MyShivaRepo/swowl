...
1. [REQ-SWR-001 — Two-panel interface layout](#req-swr-001)
2. [REQ-SWR-002 — List panel resizing](#req-swr-002)
3. [REQ-SWR-003 — Display of the SWRL rules list](#req-swr-003)
4. [REQ-SWR-004 — Visual indicator for broken references](#req-swr-004)
5. [REQ-SWR-005 — Rule search/filtering](#req-swr-005)
6. [REQ-SWR-006 — Dynamic filter update](#req-swr-006)
7. [REQ-SWR-007 — Selecting an existing rule](#req-swr-007)
8. [REQ-SWR-008 — Creating a new rule](#req-swr-008)
9. [REQ-SWR-009 — Automatic generation of a unique identifier](#req-swr-009)
10. [REQ-SWR-010 — Rule editing form](#req-swr-010)
11. [REQ-SWR-011 — Metadata synchronization from the DOM](#req-swr-011)
12. [REQ-SWR-012 — Auto-save on metadata change](#req-swr-012)
13. [REQ-SWR-013 — Saving a rule (create or update)](#req-swr-013)
14. [REQ-SWR-014 — Renaming an existing rule](#req-swr-014)
15. [REQ-SWR-015 — Deleting a rule](#req-swr-015)
16. [REQ-SWR-016 — Adding an atom to a section](#req-swr-016)
17. [REQ-SWR-017 — Removing an atom](#req-swr-017)
18. [REQ-SWR-018 — Editing an atom field](#req-swr-018)
19. [REQ-SWR-019 — Rendering a `type_atom` atom](#req-swr-019)
20. [REQ-SWR-020 — Rendering a `property_atom` atom](#req-swr-020)
21. [REQ-SWR-021 — Rendering an `equality_atom` atom](#req-swr-021)
22. [REQ-SWR-022 — Rendering a NAF block](#req-swr-022)
23. [REQ-SWR-023 — Rendering a nested conditional atom](#req-swr-023)
24. [REQ-SWR-024 — Class picker for `type_atom` atoms](#req-swr-024)
25. [REQ-SWR-025 — Selecting a class in the picker](#req-swr-025)
26. [REQ-SWR-026 — Property picker for `property_atom` atoms](#req-swr-026)
27. [REQ-SWR-027 — Selecting a property in the picker](#req-swr-027)
28. [REQ-SWR-028 — Two-panel individual picker (modal)](#req-swr-028)
29. [REQ-SWR-029 — Filtering individuals by class in the picker](#req-swr-029)
30. [REQ-SWR-030 — Selecting an individual in the picker](#req-swr-030)
31. [REQ-SWR-031 — Confirming individual selection](#req-swr-031)
32. [REQ-SWR-032 — Closing the individual picker](#req-swr-032)
33. [REQ-SWR-033 — Dynamic dropdown positioning](#req-swr-033)
34. [REQ-SWR-034 — Drag-and-drop to reorder atoms](#req-swr-034)
35. [REQ-SWR-035 — Navigating to a referenced entity from an atom](#req-swr-035)
