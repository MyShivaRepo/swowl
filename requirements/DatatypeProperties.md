...
1. [REQ-DP-001 — Initialization of the available XSD types list](#req-dp-001)
2. [REQ-DP-002 — HTML option generation for DatatypeProperties](#req-dp-002)
3. [REQ-DP-003 — HTML option generation for XSD types](#req-dp-003)
4. [REQ-DP-004 — Building the hierarchical property tree](#req-dp-004)
5. [REQ-DP-005 — Automatic expansion of a selected property's ancestors](#req-dp-005)
6. [REQ-DP-006 — Rendering a tree node with drag & drop handling](#req-dp-006)
7. [REQ-DP-007 — Rendering the full tree with owl:topDataProperty root](#req-dp-007)
8. [REQ-DP-008 — Rendering the two-panel (split) layout](#req-dp-008)
9. [REQ-DP-009 — Restoring the selection after re-rendering](#req-dp-009)
10. [REQ-DP-010 — Horizontal resizing of the left panel](#req-dp-010)
11. [REQ-DP-011 — Updating the "Super Properties" panel](#req-dp-011)
12. [REQ-DP-012 — Selecting the owl:topDataProperty root](#req-dp-012)
13. [REQ-DP-013 — Selecting a DatatypeProperty in the tree](#req-dp-013)
14. [REQ-DP-014 — Managing the toolbar button states](#req-dp-014)
15. [REQ-DP-015 — Expanding / collapsing a tree node](#req-dp-015)
16. [REQ-DP-016 — Creating a child property](#req-dp-016)
17. [REQ-DP-017 — Creating a sibling property](#req-dp-017)
18. [REQ-DP-018 — Generating a unique name for a new property](#req-dp-018)
19. [REQ-DP-019 — Effective creation and navigation to the new property](#req-dp-019)
20. [REQ-DP-020 — Displaying the context menu (right-click)](#req-dp-020)
21. [REQ-DP-021 — Closing the context menu](#req-dp-021)
22. [REQ-DP-022 — Starting the drag of a property](#req-dp-022)
23. [REQ-DP-023 — Hovering over a target during drag](#req-dp-023)
24. [REQ-DP-024 — Dropping a property onto a new target](#req-dp-024)
25. [REQ-DP-025 — Checking an ancestor/descendant link for drag & drop](#req-dp-025)
26. [REQ-DP-026 — Rendering the DatatypeProperty edit form](#req-dp-026)
27. [REQ-DP-027 — Adding an annotation row (label / comment)](#req-dp-027)
28. [REQ-DP-028 — Adding an "other property" annotation](#req-dp-028)
29. [REQ-DP-029 — Removing an annotation row](#req-dp-029)
30. [REQ-DP-030 — Checking range uniqueness before opening the picker](#req-dp-030)
31. [REQ-DP-031 — Adding / removing a domain](#req-dp-031)
32. [REQ-DP-032 — Adding an XSD type as range (with uniqueness enforcement)](#req-dp-032)
33. [REQ-DP-033 — Removing the XSD type from the range](#req-dp-033)
34. [REQ-DP-034 — Adding / removing a super-property](#req-dp-034)
35. [REQ-DP-035 — Auto-save on field change](#req-dp-035)
36. [REQ-DP-036 — Saving (creating or updating) a DatatypeProperty](#req-dp-036)
37. [REQ-DP-037 — Deleting a DatatypeProperty with confirmation](#req-dp-037)
