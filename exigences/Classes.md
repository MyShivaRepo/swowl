...
- **EX-CLS-001** — Sélection d'une classe
...
- **EX-CLS-002** — Sélection de la racine `owl:Thing`
...
- **EX-CLS-003** — Sauvegarde silencieuse lors du changement de sélection
...
- **EX-CLS-004** — Restauration de la sélection après re-rendu
  - *Si* la section est re-rendue (ex. après sauvegarde), *Alors* la sélection précédente est restaurée.

- **EX-CLS-005** — Activation contextuelle des boutons de la barre d'outils
...
- **EX-CLS-010** — Calcul de la hiérarchie
...
- **EX-CLS-020** — Création d'une classe enfant
...
- **EX-CLS-030** — Renommage via le champ ID
...
- **EX-CLS-031** — Propagation en cascade du renommage (backend)
...
- **EX-CLS-032** — Unicité du nouvel ID (backend)
...
- **EX-CLS-040** — Confirmation avant suppression
...
- **EX-CLS-041** — Blocage si des individus utilisent la classe
...
- **EX-CLS-042** — Suppression en cascade des descendants (backend)
...
- **EX-CLS-043** — Réinitialisation de la sélection après suppression
...
- **EX-CLS-053** — Déplacement par drop
...
- **EX-CLS-054** — Nettoyage après fin de drag
...
- **EX-CLS-070** — Affichage des super-classes avec chaîne ancestrale
...
- **EX-CLS-075** — Placeholder `owl:Thing`
...
- **EX-CLS-080** — Affichage des annotations existantes
...
- **EX-CLS-081** — Ajout d'un `rdfs:label`
...
- **EX-CLS-084** — Suppression d'une annotation
...
- **EX-CLS-087** — Collecte des annotations à la sauvegarde
...
- **EX-CLS-090** — Section « Asserted Properties »
...
- **EX-CLS-091** — Section « Inherited Properties »
...
- **EX-CLS-092** — Ajout d'une propriété existante
...
- **EX-CLS-093** — Création d'une ObjectProperty avec domaine = classe courante
...
- **EX-CLS-094** — Création d'une DatatypeProperty avec domaine = classe courante
...
- **EX-CLS-095** — Ajout d'une restriction à une propriété
...
- **EX-CLS-096** — Bascule filler / cardinalité
...
- **EX-CLS-097** — Sélection de la classe filler
...
- **EX-CLS-098** — Navigation depuis une restriction héritée
...
- **EX-CLS-099** — Suppression d'une restriction enfant
...
- **EX-CLS-100** — Suppression d'une propriété entière
...
- **EX-CLS-101** — Marqueur de présence (`_marker`)
...
- **EX-CLS-102** — Chip de multiplicité
...
- **EX-CLS-103** — Navigation vers la propriété
...
- **EX-CLS-104** — Synchronisation `_marker` ↔ domaine (backend)
...
- **EX-CLS-130** — Sanitisation en temps réel (frontend)
...
- **EX-CLS-131** — Validation avant sauvegarde (frontend)
...
- **EX-CLS-132** — Validation côté backend
...
- **EX-CLS-140** — Déclenchement de l'AutoSave
...
- **EX-CLS-141** — Sauvegarde silencieuse
...
- **EX-CLS-142** — Collecte complète à la sauvegarde
...
- **EX-CLS-152** — Frame « Where Used in Rules »
...
- **EX-CLS-160** — Persistance immédiate
...
- **EX-CLS-172** — Redimensionnement des sections du formulaire
