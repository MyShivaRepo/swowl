...
1. [REQ-IND-001 — Rendu en trois colonnes](#req-ind-001)
2. [REQ-IND-002 — Arbre de classes avec compteurs transitifs](#req-ind-002)
3. [REQ-IND-003 — Liste des individuals filtrée et triée](#req-ind-003)
4. [REQ-IND-004 — Sélection d'une classe dans l'arbre](#req-ind-004)
5. [REQ-IND-005 — Sélection simple d'un individual](#req-ind-005)
6. [REQ-IND-006 — Sélection multiple par Shift+Clic](#req-ind-006)
7. [REQ-IND-007 — Création d'un nouvel individual](#req-ind-007)
8. [REQ-IND-008 — Annulation du formulaire de création](#req-ind-008)
9. [REQ-IND-009 — Suppression d'un ou plusieurs individuals](#req-ind-009)
10. [REQ-IND-010 — Déplacement par glisser-déposer vers une classe](#req-ind-010)
11. [REQ-IND-011 — Formulaire de détail d'un individual](#req-ind-011)
12. [REQ-IND-012 — Identifiant IRI affiché dans l'en-tête du formulaire](#req-ind-012)
13. [REQ-IND-013 — Annotations : labels et commentaires](#req-ind-013)
14. [REQ-IND-014 — Annotations de propriétés personnalisées](#req-ind-014)
15. [REQ-IND-015 — Gestion des types (rdf:type)](#req-ind-015)
16. [REQ-IND-016 — Panneaux de propriétés dynamiques (Object Properties)](#req-ind-016)
17. [REQ-IND-017 — Panneaux de propriétés dynamiques (Datatype Properties)](#req-ind-017)
18. [REQ-IND-018 — Gestion de la cardinalité fonctionnelle des propriétés](#req-ind-018)
19. [REQ-IND-019 — Ouverture du sélecteur d'individual pour une Object Property](#req-ind-019)
20. [REQ-IND-020 — Création d'un individual à la volée depuis le sélecteur](#req-ind-020)
21. [REQ-IND-021 — Sauvegarde automatique (autoSave)](#req-ind-021)
22. [REQ-IND-022 — Sauvegarde explicite : création et mise à jour](#req-ind-022)
23. [REQ-IND-023 — Suppression unitaire d'un individual depuis le formulaire](#req-ind-023)
24. [REQ-IND-024 — Préservation de sameAs et differentFrom lors de la sauvegarde](#req-ind-024)
25. [REQ-IND-025 — Collecte des assertions d'objet depuis les panneaux](#req-ind-025)
26. [REQ-IND-026 — Collecte des assertions de données depuis les panneaux](#req-ind-026)
27. [REQ-IND-027 — Règle d'affichage simple (propriété unique)](#req-ind-027)
28. [REQ-IND-028 — Règle d'affichage composite (multi-propriétés avec séparateur)](#req-ind-028)
29. [REQ-IND-029 — Résolution du label d'affichage par héritage de classe](#req-ind-029)
30. [REQ-IND-030 — Résolution du label rdfs:label multilingue](#req-ind-030)
31. [REQ-IND-031 — Persistance des règles d'affichage dans l'ontologie](#req-ind-031)
32. [REQ-IND-032 — Génération automatique de l'identifiant d'un nouvel individual](#req-ind-032)
33. [REQ-IND-033 — Navigation vers un individual cible depuis une Object Property](#req-ind-033)
34. [REQ-IND-034 — Lien cliquable pour les valeurs de données de type URL](#req-ind-034)
35. [REQ-IND-035 — Panneau "Where Used" dans le formulaire](#req-ind-035)
36. [REQ-IND-036 — Redimensionnement des colonnes par glisser-déposer](#req-ind-036)
37. [REQ-IND-037 — Profondeur hiérarchique des classes pour l'ordonnancement](#req-ind-037)
38. [REQ-IND-038 — Collecte séparée des propriétés héritées et directes](#req-ind-038)
39. [REQ-IND-039 — Filtre des individuals candidats par range d'une OP](#req-ind-039)
