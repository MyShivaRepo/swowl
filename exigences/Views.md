...
1. [REQ-VW-001 — Rendu de l'onglet Views avec sous-onglets](#req-vw-001)
2. [REQ-VW-002 — Sous-onglet « Ontology » : arbre hyperbolique D3](#req-vw-002)
3. [REQ-VW-003 — Construction de l'arbre hiérarchique des classes](#req-vw-003)
4. [REQ-VW-004 — Résolution du meilleur label de classe](#req-vw-004)
5. [REQ-VW-005 — Algorithme de placement hyperbolique (disque de Poincaré)](#req-vw-005)
6. [REQ-VW-006 — Dessin SVG des nœuds et arêtes avec opacité et taille proportionnelles](#req-vw-006)
7. [REQ-VW-007 — Clic sur un nœud : centrage par transformation de Möbius](#req-vw-007)
8. [REQ-VW-008 — Double-clic (second clic au centre) : navigation vers l'éditeur de classes](#req-vw-008)
9. [REQ-VW-009 — Réinitialisation du focus vers la racine](#req-vw-009)
10. [REQ-VW-010 — Filtrage des classes par texte dans le graphe hyperbolique](#req-vw-010)
11. [REQ-VW-011 — Compteur de classes affiché dans la barre d'outils](#req-vw-011)
12. [REQ-VW-012 — Sous-onglet « Knowledge Base » : graphe de force D3](#req-vw-012)
13. [REQ-VW-013 — Construction des nœuds (individuals) et liens (assertions)](#req-vw-013)
14. [REQ-VW-014 — Palette de couleurs par classe](#req-vw-014)
15. [REQ-VW-015 — Résolution du meilleur label d'individual](#req-vw-015)
16. [REQ-VW-016 — Légende des classes dans le graphe Knowledge Base](#req-vw-016)
17. [REQ-VW-017 — Arrowheads SVG sur les arêtes directionnelles](#req-vw-017)
18. [REQ-VW-018 — Zoom et pan sur le graphe Knowledge Base](#req-vw-018)
19. [REQ-VW-019 — Labels de propriétés sur les arêtes](#req-vw-019)
20. [REQ-VW-020 — Clic sur un nœud individual : navigation vers l'éditeur d'individuals](#req-vw-020)
21. [REQ-VW-021 — Survol d'un nœud : mise en évidence des connexions](#req-vw-021)
22. [REQ-VW-022 — Glisser-déposer des nœuds dans le graphe Knowledge Base](#req-vw-022)
23. [REQ-VW-023 — Simulation de force D3 avec paramètres configurés](#req-vw-023)
24. [REQ-VW-024 — Redémarrage de la simulation de force](#req-vw-024)
25. [REQ-VW-025 — Filtrage des individuals par texte dans le graphe Knowledge Base](#req-vw-025)
26. [REQ-VW-026 — Compteur d'individuals et de connexions](#req-vw-026)
27. [REQ-VW-027 — Blocage de l'onglet Views si aucune ontologie n'est connectée](#req-vw-027)
28. [REQ-VW-028 — Initialisation différée des graphes après rendu HTML](#req-vw-028)
